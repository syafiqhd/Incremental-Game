...
public class GameManager : MonoBehaviour
{
    ...
    // Fungsi [Range (min, max)] ialah menjaga value agar tetap berada di antara min dan max-nya dari inspector
    [Range(0f, 1f)]
    ...
    private void CollectPerSecond()
    {
        ...
        CoinIcon.transform.localScale = Vector3.one * 1.9f;
    ...
    {
        _totalGold += value;
        GoldInfo.text = $"Rp. { _totalGold.ToString("N0")}";
    }
    ...
    public void CollectByTap(Vector3 tapPosition, Transform parent)
    {
        ...
        tapText.Text.text = $"+Rp. { output.ToString("N0") }";
